...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM(name="source_status", create_type=False), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("id", postgresql.UUID(as_uuid=True), primary_key=True, server_default=sa.text("gen_random_uuid()")),
        sa.Column("course_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("courses.id", ondelete="CASCADE"), nullable=False),
        sa.Column("status", postgresql.ENUM(name="generation_status", create_type=False), nullable=False, server_default="planning"),
